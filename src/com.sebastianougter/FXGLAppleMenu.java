...
/**
 * Denne klasse er baseret på AlmasB's default FXGL menu, men modereret så den passer til mit spil.
 *
 * @author Almas Baimagambetov (AlmasB) (almaslvl@gmail.com)
 *  @author Sebastian Ougter Olsen (SebastianOugterOlsen) (seba3440@edu.easj.dk)
 */
public class FXGLAppleMenu extends FXGLMenu {

    public FXGLAppleMenu(GameApplication app, MenuType type) {
        super(app, type);
    ...
    @Override
    protected Node createBackground(double width, double height) { //Overskrives i "MySceneFactory"
    ...
    @Override
    protected Node createTitleView(String title) { //Overskrives i "MySceneFactory"
    ...
    protected Node createVersionView(String version) {
        ...
        view.setTranslateY(app.getHeight() - 10);
    ...
    protected Node createProfileView(String profileName) {
        ...
        view.setTranslateY(app.getHeight() - 10);
        view.setTranslateX(app.getWidth() - view.getLayoutBounds().getWidth() - 10);
    ...
    protected MenuBox createOptionsMenu() {
        ...
        return new MenuBox(200, itemControls, itemVideo, btnRestore);
    }
